...
export interface ApiDetailTransaksiDetailTransaksi
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    layanan: Schema.Attribute.Relation<'manyToOne', 'api::layanan.layanan'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    transaksi: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiLayananLayanan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deskripsi: Schema.Attribute.Text;
    detail_transaksis: Schema.Attribute.Relation<
      'oneToMany',
      'api::detail-transaksi.detail-transaksi'
    >;
...
export interface ApiOmsetOmset extends Struct.SingleTypeSchema {
  collectionName: 'omsets';
  info: {
    displayName: 'Omset';
    pluralName: 'omsets';
    singularName: 'omset';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::omset.omset'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    total_omset: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPelangganPelanggan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    transaksis: Schema.Attribute.Relation<
      'oneToMany',
      'api::transaksi.transaksi'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTransaksiTransaksi extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pelanggan: Schema.Attribute.Relation<
      'manyToOne',
      'api::pelanggan.pelanggan'
    >;
    publishedAt: Schema.Attribute.DateTime;
